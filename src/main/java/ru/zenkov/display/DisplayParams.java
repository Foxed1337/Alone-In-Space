...
public class DisplayParams {
    ...
    public static final Callable<Void> DEFAULT_ON_CLOSE_ROUTINE = new Callable<Void>() {
        @Override
    ...
    protected Callable<Void> onCloseRoutine;
    ...
    private DisplayParams() {
        ...
        this.onCloseRoutine = DEFAULT_ON_CLOSE_ROUTINE;
    ...
    public DisplayParams withCustomOnCloseOperation(Callable<Void> routine) {
        this.onCloseRoutine = routine;
        return this;
    }
    ...
    public DisplayParams makeWithAntialiasing() {
        this.withAntialiasing = true;
        return this;
    }
